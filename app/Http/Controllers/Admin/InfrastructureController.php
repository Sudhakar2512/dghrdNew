...
class InfrastructureController extends Controller
{
    ...
    public function Infra_officer_details_save(Request $request)
    {
        ...
        return redirect(url('add-infra_officer-details'))->with(['success' => 'Officer Detailes uploaded Successfully']);
    }
    ...
    public function Infra_officer_details_update(Request $request, $id)
    {
        ...
        $data->save();
        return redirect(url('add-infra_officer-details'))->with(['success' => 'Officer Detailes Updated Successfully']);
    }

    public function Infra_officer_details_delete($id)
    {
        $data = InfrastructureOfficerDetail::where('id', $id)->delete();
        return redirect(url('add-infra_officer-details'))->with(['error' => 'Officer Detailes deleted successfully']);
    }
    ...
    public function instructions_save(Request $request)
    {
        ...
        return redirect(url('add-instructions-details'))->with(['success' => 'Instructions uploaded Successfully']);
    }
    ...
    public function instructions_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-instructions-details'))->with(['success' => 'Instructions Updated Successfully']);
    }

    public function instructions_delete($id)
    {
        $data = Instruction::where('id', $id)->delete();
        return redirect(url('add-instructions-details'))->with(['error' => 'Instructions deleted successfully']);
    }
...
public function fastTrack_view($id = null)
    ...
    public function fastTrack_save(Request $request)
    {
        ...
        return redirect(url('add-fast_track-details'))->with(['success' => 'FastTrack uploaded Successfully']);
    }
    ...
    public function fastTrack_update(Request $request, $id)
    {
        #validation
        $this->validate($request, [
            "pdf" => "mimes:doc,pdf,docx,xlsx,xls,csv,txt,rtf,png,jpg,jpeg,odt,ods,pptx,ppt,gif,ppt,xls,xls",
            'tittle' => "required"
        ]);
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-fast_track-details'))->with(['success' => 'FastTrack Updated Successfully']);
    }

    public function FastTrack_delete($id)
    {
        $data = FastTrack::where('id', $id)->delete();
        return redirect(url('add-fast_track-details'))->with(['error' => 'FastTrack deleted successfully']);
    }
...
public function ppt_view($id = null)
    ...
    public function ppt_save(Request $request)
    {
        ...
        return redirect(url('add-ppt-details'))->with(['success' => 'PPT uploaded Successfully']);
    }
    ...
    public function ppt_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-ppt-details'))->with(['success' => 'PPT Updated Successfully']);
    }

    public function ppt_delete($id)
    {
        $data = InfrastructurePpt::where('id', $id)->delete();
        return redirect(url('add-ppt-details'))->with(['error' => 'PPT deleted successfully']);
    }
...
public function manual_view($id = null)
    ...
    public function manual_save(Request $request)
    {
        ...
        return redirect(url('add-manual-details'))->with(['success' => 'Manual uploaded Successfully']);
    }
    ...
    public function manual_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-manual-details'))->with(['success' => 'Manual Updated Successfully']);
    }

    public function manual_delete($id)
    {
        $data = InfrastructureManual::where('id', $id)->delete();
        return redirect(url('add-manual-details'))->with(['error' => 'Manual deleted successfully']);
    }
...
public function asset_register_save(Request $request)
{
    ...
    return redirect(url('add-asset_register-details'))->with(['success' => 'Asset Registers uploaded Successfully']);
}
...
public function asset_register_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-asset_register-details'))->with(['success' => 'Asset Registers Updated Successfully']);
}

public function asset_register_delete($id)
{
    $data = AssetRegister::where('id', $id)->delete();
    return redirect(url('add-asset_register-details'))->with(['error' => 'Asset Registers deleted successfully']);
}
...
public function land_asset_save(Request $request)
{
    ...
    return redirect(url('add-land_assets-details'))->with(['success' => 'Land Assets uploaded Successfully']);
}
...
public function land_asset_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-land_assets-details'))->with(['success' => 'Land Assets Updated Successfully']);
}

public function land_asset_delete($id)
{
    $data = LandAssets::where('id', $id)->delete();
    return redirect(url('add-land_assets-details'))->with(['error' => 'Land Assets deleted successfully']);
}
...
public function construction_save(Request $request)
{
    ...
    return redirect(url('add-construction-details'))->with(['success' => 'Construction data uploaded Successfully']);
}
...
public function construction_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-construction-details'))->with(['success' => 'Construction data  Updated Successfully']);
}

public function construction_delete($id)
{
    $data = Construction::where('id', $id)->delete();
    return redirect(url('add-construction-details'))->with(['error' => 'Construction data  deleted successfully']);
}
...
public function repair_maintenance_save(Request $request)
{
    ...
    return redirect(url('add-repair_maintenance-details'))->with(['success' => 'Repair & Maintainence data uploaded Successfully']);
}
...
public function repair_maintenance_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-repair_maintenance-details'))->with(['success' => 'Repair & Maintainence data  Updated Successfully']);
}

public function repair_maintenance_delete($id)
{
    $data = RepairMaintenance::where('id', $id)->delete();
    return redirect(url('add-repair_maintenance-details'))->with(['error' => 'Repair & Maintainence data  deleted successfully']);
}
...
public function ready_built_save(Request $request)
{
    ...
    return redirect(url('add-ready_built-details'))->with(['success' => 'Ready Built Accomodation data uploaded Successfully']);
}
...
public function ready_built_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-ready_built-details'))->with(['success' => 'Ready Built Accomodation data Updated Successfully']);
}

public function ready_built_delete($id)
{
    $data = ReadyBuilt::where('id', $id)->delete();
    return redirect(url('add-ready_built-details'))->with(['error' => 'Ready Built Accomodation data deleted successfully']);
}
...
public function hired_office_save(Request $request)
{
    ...
    return redirect(url('add-hired_office-details'))->with(['success' => 'Hired Offices data uploaded Successfully']);
}
...
public function hired_office_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-hired_office-details'))->with(['success' => 'Hired Offices data Updated Successfully']);
}

public function hired_office_delete($id)
{
    $data = HiredOffice::where('id', $id)->delete();
    return redirect(url('add-hired_office-details'))->with(['error' => 'Hired Offices data deleted successfully']);
}
...
public function Various_communication_save(Request $request)
{
    ...
    return redirect(url('add-various_coomunication-details'))->with(['success' => 'Various Communications data uploaded Successfully']);
}
...
public function Various_communication_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-various_coomunication-details'))->with(['success' => 'Various Communications data Updated Successfully']);
}

public function Various_communication_delete($id)
{
    $data = VariousCommunication::where('id', $id)->delete();
    return redirect(url('add-various_coomunication-details'))->with(['error' => 'Various Communications data deleted successfully']);
}
