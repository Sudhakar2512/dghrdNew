    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">उपयोग क्रेडेंशियल्स जोड़ें</h4>
            </div>
            <div class="card-body">
                    ...
                    <form class="form-valide-with-icon needs-validation" novalidate method="POST" action="{{ route('adminlogin') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="email" class="form-control" name="email" id="validationCustomUsername" placeholder="एक ईमेल दर्ज करें .." required>
                        ...
                        <div class="mb-3">
                            <label class="text-label form-label" for="dz-password">पासवर्ड *</label>
                            <div class="input-group transparent-append">
                                <span class="input-group-text"> <i class="fa fa-lock"></i> </span>
                                <input type="password" class="form-control" name="password" id="dz-password" placeholder="एक सुरक्षित पासवर्ड चुनें .." required>
                        ...
                        <button type="submit" class="btn me-2 btn-primary">जमा करना</button>
    ...
    <div class="col-xl-12">
      <div class="card dz-card" id="accordion-one">
        <div class="card-header flex-wrap">
          <div>
            <h4 class="card-title">लॉगिन विवरण</h4>
            ...
            <div class="table-responsive">
              <table id="example" class="display table" style="min-width: 845px">
                ...
                <tbody>
                  @if ($data->isEmpty())
                  <tr>
                    <td colspan="5">कोई डेटा मौजूद नहीं।</td>
                  </tr>
                @else
                  @foreach ($data as $d)
                  ...
                  <tr>
                    ...
                    <!--<td>{{ $d->added_by}}</td>-->
                    @if($d->status=='0')
                    <td><a href="{{ route('approvelogin', ['id' => $d->id]) }}"><span class="badge light badge-warning">निष्क्रिय करें</span></a></td>
                    @else
                    <td><a href="{{ route('dis_approvelogin', ['id' => $d->id]) }}"><span class="badge light badge-success">सक्रिय करना</span></a></td>
                   @endif
    ...
    <div class="modal fade" id="basicModal">
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body "><h6 class="text-center">निवेदन पहले ही स्वीकृत किया जा चुका है।</h6></div>
