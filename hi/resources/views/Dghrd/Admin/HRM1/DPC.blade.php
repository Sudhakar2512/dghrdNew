...
<div class="mb-3">
    <div class="form-group">
      ...
      <select class="form-select" name="tab" required>
        ...
        <option value="1" @if($value && $value->tab == "1") selected @endif> समूह ए</option>
        <option value="2" @if($value && $value->tab == "2") selected @endif> समूह बी को ए</option>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Dpc Mpdule Update
                            Table</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
