...
<div class="mb-3">
    <div class="form-group">
      ...
      <select class="form-select" name="tab" required>
        ...
        <option value="1" @if($value && $value->tab == "1") selected @endif>एपीएआर का ऑनलाइन लेखन</option>
        <option value="2" @if($value && $value->tab == "2") selected @endif>आईपीआर का ऑनलाइन लेखन</option>
        <option value="3" @if($value && $value->tab == '3') selected @endif>स्पैरो सहायता मैनुअल</option>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if($data->tab =='1' ?? '')
                                                एपीएआर का ऑनलाइन लेखन
                                                @elseif($data->tab =='2' ?? '')
                                                आई पी आर का ऑनलाइन लेखन
                                                @elseif($data->tab =='3' ?? '')
                                                स्पैरो सहायता मैनुअल
                                                @endif
                                            </td>
