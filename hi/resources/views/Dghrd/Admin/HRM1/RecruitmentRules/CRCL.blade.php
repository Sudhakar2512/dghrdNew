    ...
    <div class="mb-3">
        <div class="form-group">
          ...
          <select class="form-select" name="sub_tab" required>
            ...
            <option value="1" @if($value && $value->sub_tab == '1' ) selected @endif>रासायनिक सहायक</option>
            <option value="2" @if($value && $value->sub_tab == '2') selected @endif>सीआरसीएल जीआर-ए & बी</option>
            <option value="3" @if($value && $value->sub_tab == '3') selected @endif>सीआरसीएल जीआर-सी</option>
