    ...
    <div class="mb-3">
        <div class="form-group">
          ...
          <select class="form-select" name="sub_tab" required>
            ...
            <option value="1" @if($value && $value->sub_tab == '1' ) selected @endif>चालक विशेष ग्रेड</option>
            <option value="2" @if($value && $value->sub_tab == '2') selected @endif>जीआर-सी ड्राइवर</option>
            <option value="3" @if($value && $value->sub_tab == '3') selected @endif>समूह-बी पद</option>
            <option value="4" @if($value && $value->sub_tab == '4') selected @endif>समूह-सी सीबीएन</option>
            <option value="5" @if($value && $value->sub_tab  == '5') selected @endif>एमटीएस सीबीएन</option>
          </select>
        </div>
        @error('sub_tab')
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">CENTRAL BUREAU OF NARCOTICS(CBN)
