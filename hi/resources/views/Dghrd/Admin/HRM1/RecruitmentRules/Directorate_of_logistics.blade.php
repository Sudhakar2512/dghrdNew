    ...
    <div class="mb-3">
        <div class="form-group">
          ...
          <select class="form-select" name="sub_tab" required>
            ...
            <option value="1" @if($value && $value->sub_tab == '1' ) selected @endif>समूह-ए</option>
            <option value="2" @if($value && $value->sub_tab == '2') selected @endif>समूह-बी</option>
            <option value="3" @if($value && $value->sub_tab == '3') selected @endif>समूह-सी एंड डी</option>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">DIRECTORATE OF LOGISTICS
