    ...
    <div class="mb-3">
        <div class="form-group">
          ...
          <select class="form-select" name="sub_tab" required>
            <option value="">शीर्षक चुनें ...</option>
            <option value="1" @if($value && $value->sub_tab == '1' ) selected @endif>समूह-सी पोस्ट</option>
            <option value="2" @if($value && $value->sub_tab == '2') selected @endif>अतिरिक्त सहायक निदेशक की भर्ती नियम</option>
            <option value="3" @if($value && $value->sub_tab == '3') selected @endif>स्टेनोग्राहेर जीआर-आई के भर्ती नियम</option>
            <option value="4" @if($value && $value->sub_tab == '4') selected @endif>कर सहायक</option>
            <option value="5" @if($value && $value->sub_tab  == '5') selected @endif>कार्यकारी सहेयक</option>
            <option value="6" @if($value && $value->sub_tab  == '6') selected @endif>स्टाफ कार चालक (विशेष ग्रेड)</option>
          </select>
        </div>
        @error('sub_tab')
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">RRs of DIRECTORATES
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                अतिरिक्त सहायक निदेशक की भर्ती नियम
                                                @elseif($data->sub_tab =='3' ?? '')
                                                स्टेनोग्राहेर जीआर-आई के भर्ती नियम
                                                @elseif($data->sub_tab =='4' ?? '')
                                                कर सहायक
                                                @elseif($data->sub_tab =='5' ?? '')
                                                कार्यकारी सहेयक
                                                @elseif($data->sub_tab =='6' ?? '')
                                                स्टाफ कार चालक (विशेष ग्रेड)
                                                @endif
                                            </td>
