...
<div class="mb-3">
    ...
    <div class="form-group">
        ...
        <select class="form-select" name="subtab"  required>
            ...
            <option value="1" @if($value && $value->sub_tab  == '1' ) selected @endif>सहायक निदेशक के भर्ती नियम (ओएल)</option>
            <option value="2" @if($value && $value->sub_tab == '2') selected @endif>सीएओ की भर्ती नियम</option>
            <option value="3" @if($value && $value->sub_tab == '3') selected @endif>उप निदेशक की भर्ती नियम (ओएल)</option>
            <option value="4" @if($value && $value->sub_tab == '4') selected @endif>आईआरएस की भर्ती नियम</option>
          </select>
    </div>
    @error('subtab')
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                @if($data->sub_tab =='1' ?? '')
                                                सहायक निदेशक के भर्ती नियम (ओएल)
                                                @elseif($data->sub_tab =='2' ?? '')
                                                सीएओ की भर्ती नियम
                                                @elseif($data->sub_tab =='3' ?? '')
                                                उप निदेशक की भर्ती नियम (ओएल)
                                                @elseif($data->sub_tab =='4' ?? '')
                                                आईआरएस की भर्ती नियम
                                                @endif
                                            </td>
