                                                ...
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                      ...
                                                      <select class="form-select" name="sub_tab" required>
                                                        ...
                                                        <option value="1" @if($value && $value->sub_tab == '1' ) selected @endif>जीआर सी और डी पोस्ट</option>
                                                        <option value="2" @if($value && $value->sub_tab == '2') selected @endif>प्रबंधक प्रेस</option>
