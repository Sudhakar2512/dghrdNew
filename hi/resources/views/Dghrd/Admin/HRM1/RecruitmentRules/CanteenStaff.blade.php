                                                ...
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                      ...
                                                      <select class="form-select" name="sub_tab" required>
                                                        ...
                                                        <option value="2" @if($value && $value->sub_tab ?? '' == '2') selected @endif>प्रबंधक ग्रेड- II और प्रबंधक सह लेखाकार</option>
                                                      </select>
                                                    </div>
                                                    @error('sub_tab')
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Canteen Staff
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                प्रबंधक ग्रेड- II और प्रबंधक सह लेखाकार
                                                @endif
                                            </td>
