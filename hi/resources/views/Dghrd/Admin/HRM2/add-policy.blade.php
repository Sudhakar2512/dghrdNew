                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="tab" required>
                                                ...
                                                <option value="1" @if($value && $value->tab == "1") selected @endif>आवंटन मॉड्यूल अपडेट्स</option>
                                                <option value="2" @if($value && $value->tab == "2") selected @endif>अन्य</option>
