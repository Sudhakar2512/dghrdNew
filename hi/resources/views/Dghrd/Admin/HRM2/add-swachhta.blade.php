                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="tab" required>
                                                ...
                                                <option value="1" @if($value && $value->tab == "1") selected @endif>पत्र</option>
                                                <option value="2" @if($value && $value->tab == "2") selected @endif>पुरस्कार</option>
                                                <option value="3" @if($value && $value->tab == '3') selected @endif>पुस्तिकाएं</option>
                                                <option value="4" @if($value && $value->tab == '3') selected @endif>व्यय</option>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Swachhta Action Plan
                            Table</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
