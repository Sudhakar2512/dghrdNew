                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-select" name="tab" required>
                                                ...
                                                <option value="1" @if($value && $value->tab == "1") selected @endif>उन अधिकारियों की सूची जिनके सत्यापित डेटा का इंतजार था</option>
                                                <option value="2" @if($value && $value->tab == "2") selected @endif>प्रोफार्मा</option>
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Verified Data
                            Table</h4>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <table id="example3" class="display table" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($data->tab =='1' ?? '')
                                            उन अधिकारियों की सूची जिनके सत्यापित डेटा का इंतजार था
                                            @elseif($data->tab =='2' ?? '')
                                            प्रोफार्मा
                                            @endif
                                        </td>
