        ...
        <div class="container">
            <div class="py-2">
                <h5 class="my-auto">
                    ...
                    >> एचआरएम 1 >> भर्ती नियम >> <span> @if($tab == 'systum_data_management')
                        सिस्टम और डेटा प्रबंधन
                        @elseif($tab == 'telecommunication_wing')
                        दूरसंचार विंग, लॉजिस्टिक्स निदेशालय
                        @else
                        स्पैरो हेल्प मैनुअल
                        @endif
                    </span>
                    ...
                    <div style="overflow-x:auto;" class="table-responsive">
                        <table class="table table-bordered dataTable" style="border:1px solid lightgrey; width:100%;">
                            ...
                            <tbody class="">
                                ...
                                @endforeach
                                @foreach($sparrowContent as $content)
                                <tr>
                                    <td>
                                        @php
