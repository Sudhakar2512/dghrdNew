...
<section>
    <div class="container-fluid bg-menu-open">
        <div class="container">
            <div class="py-2">
                <h5 class="my-auto">
                    <a href="{{url('/')}}" class="aa txt-clr"><i class="fa fa-home"></i> होम </a> >> <span>सुझाव</span>
                </h5>
            </div>
        </div>
                ...
                <div class="container cnt-pd">
                    <div class="card border-0">
                        <div class="card-body px-0 px-lg-2">
                            <h5 class="mb-4">विभागीय अधिकारियों के संगठनात्मक मुद्दों पर सुझाव, जिसमें HR और इन्फ्रास्ट्रक्चर शामिल हैं।</h5>
                                ...
                                <div class="row col-12 mx-auto">
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            <label for="name" class="text-dark">नाम<span class="text-danger">*</span>:</label>
                                            <input type="text" name="name" class="form-control mt-2 border-dark" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group mb-2">
                                            <label for="mobile" class="text-dark">मोबाइल<span class="text-danger">*</span>:</label>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group mb-2">
                                            <label for="email" class="text-dark">ईमेल पता<span class="text-danger">*</span>:</label>
                                            <input type="email" name="email" class="form-control mt-2 border-dark" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group mb-2">
                                            <label for="subject" class="text-dark">विषय<span class="text-danger">*</span>:</label>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group mb-2">
                                            <label for="suggestions" class="text-dark">सुझाव<span class="text-danger">*</span>:</label>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-group mb-2">
                                            <label for="g-recaptcha" class="text-dark">कैप्चा<span class="text-danger">*</span>:</label>
                                            <div class="g-recaptcha" data-sitekey="6Ld-IWQpAAAAAMgHp73vBRn-kBufdMYQWcinc06V"></div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <button type="submit" class="btn  thm-clr text-white">जमा करें</button>
                                    </div>
                                </div>
                            </form>
                        </div>
