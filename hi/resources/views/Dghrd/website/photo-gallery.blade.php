...
<section>
  <div class="container-fluid bg-menu-open">
    <div class="container">
      <div class="py-2">
        <h5 class="my-auto"><a href="{{url('/')}}" class="aa txt-clr"><i class="fa fa-home"></i> होम </a> >> <span> फोटो गैलरी</span></h5>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="col-xl-11 col-lg-12 col-md-12 mg-box-top px-0 mx-auto">
      ...
      <div class="gallery ">
        <div class="row col-12 mx-auto">
          ...
          <div class="col-lg-3 col-md-4 col-sm-4 col-6 mt-2 px-2">

            <div class="card h-100">
              <div class="card-body gallery-img p-1">
                <a href="{{asset('Admin/Images').'/'.$item->image ?? ''}}">
                  <img src="{{asset('Admin/Images').'/'.$item->image ?? ''}}" title="">
                </a>
              </div>
              <div class="card-footer  gallery-title d-flex align-items-center justify-content-center p-1" style="overflow-y:auto;">
                <div class="text-center">
                  <h6 class="my-auto ">{{ $item->tittle }}</h6>
                </div>
              </div>
            </div>
          </div>
