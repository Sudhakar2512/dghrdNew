        ...
        <div class="container-fluid h-100">
                 ...
                 @endif
					<div class="login-form">
                        ...
                        <form class="form-valide-with-icon needs-validation" novalidate method="POST" action="{{ route('logincheck') }}">
                            @csrf
            <div class="mb-3">
                <label class="text-label form-label" for="validationCustomUsername">ईमेल</label>
            ...
            <div class="mb-3">
                ...
                <div class="input-group transparent-append">
                    ...
                    <input type="password" class="form-control" name="password" id="dz-password" placeholder="पास वर्ड दर्ज करें" required>
                    ...
                    <div class="invalid-feedback">
                        कृपया एक पासवर्ड दर्ज करें।
                            ...
                            <div class="text-center mt-4">
                                <button type="submit" class="btn btn-primary btn-block">दाखिल करना</button>
                            </div>
                        </form>
					</div>
				</div>
