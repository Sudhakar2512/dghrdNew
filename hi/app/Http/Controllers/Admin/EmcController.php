...
#officer Detailes
     ...
     public function emc_officer_save(Request $request)
    {
        ...
        return redirect(url('add-emc_officer-details'))->with(['success' => 'Officer details uploaded Successfully']);
    }
    ...
    public function emc_officer_update(Request $request, $id)
    {
        ...
        $data->save();
        return redirect(url('add-emc_officer-details'))->with(['success' => 'Officer details Updated Successfully']);
    }

    public function emc_officer_delete($id)
    {
        $data = EmcOfficerDetail::where('id', $id)->delete();
        return redirect(url('add-emc_officer-details'))->with(['error' => 'Officer details deleted successfully']);
    }
     ...
     public function fund_allocation_save(Request $request)
    {
        ...
        return redirect(url('add-fund_allocation-details'))->with(['success' => 'Fund Allocation uploaded Successfully']);
    }
    ...
    public function fund_allocation_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-fund_allocation-details'))->with(['success' => 'Fund Allocation Updated Successfully']);
    }

    public function fund_allocation_delete($id)
    {
        $data = FundAllocation::where('id', $id)->delete();
        return redirect(url('add-fund_allocation-details'))->with(['error' => 'Fund Allocation deleted successfully']);
    }
     ...
     public function emc_ppt_save(Request $request)
    {
        ...
        return redirect(url('add-emc_ppt-details'))->with(['success' => 'PPT uploaded Successfully']);
    }
    ...
    public function emc_ppt_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-emc_ppt-details'))->with(['success' => 'PPT Updated Successfully']);
    }

    public function emc_ppt_delete($id)
    {
        $data = EmcPpt::where('id', $id)->delete();
        return redirect(url('add-emc_ppt-details'))->with(['error' => 'PPT deleted successfully']);
    }
#EMC Manual
     ...
     public function emc_manual_save(Request $request)
    {
        ...
        return redirect(url('add-emc_manual-details'))->with(['success' => 'Manual uploaded Successfully']);
    }
    ...
    public function emc_manual_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-emc_manual-details'))->with(['success' => 'Manual Updated Successfully']);
    }

    public function emc_manual_delete($id)
    {
        $data = EmcManual::where('id', $id)->delete();
        return redirect(url('add-emc_manual-details'))->with(['error' => 'Manual deleted successfully']);
    }
     ...
     public function budgetary_authority_save(Request $request)
    {
        ...
        return redirect(url('add-budgetary_authority-details'))->with(['success' => 'Budgetary authority uploaded Successfully']);
    }
    ...
    public function budgetary_authority_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-budgetary_authority-details'))->with(['success' => 'Budgetary authority Updated Successfully']);
    }

    public function budgetary_authority_delete($id)
    {
        $data = BudgetaryAuthority::where('id', $id)->delete();
        return redirect(url('add-budgetary_authority-details'))->with(['error' => 'Budgetary authority deleted successfully']);
    }
     ...
     public function gem_eprocurements_save(Request $request)
    {
        ...
        return redirect(url('add-gem_eprocurements-details'))->with(['success' => 'Gem details uploaded Successfully']);
    }
    ...
    public function gem_eprocurements_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-gem_eprocurements-details'))->with(['success' => 'Gem details Updated Successfully']);
    }

    public function gem_eprocurements_delete($id)
    {
        $data = GemEprocurement::where('id', $id)->delete();
        return redirect(url('add-gem_eprocurements-details'))->with(['error' => 'Gem details deleted successfully']);
    }
 ...
 public function vehicle_policy_save(Request $request)
{
    ...
    return redirect(url('add-vehicle_policy-details'))->with(['success' => 'Vehicle policy uploaded Successfully']);
}
...
public function vehicle_policy_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-vehicle_policy-details'))->with(['success' => 'Vehicle policy Updated Successfully']);
}

public function vehicle_policy_delete($id)
{
    $data = VehiclePolicy::where('id', $id)->delete();
    return redirect(url('add-vehicle_policy-details'))->with(['error' => 'Vehicle policy deleted successfully']);
}
 ...
 public function crb_save(Request $request)
{
    ...
    return redirect(url('add-crb-details'))->with(['success' => 'CRB uploaded Successfully']);
}
...
public function crb_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-crb-details'))->with(['success' => 'CRB Updated Successfully']);
}

public function crb_delete($id)
{
    $data = Crb::where('id', $id)->delete();
    return redirect(url('add-crb-details'))->with(['error' => 'CRB deleted successfully']);
}
 ...
 public function emc_communication_save(Request $request)
{
    ...
    return redirect(url('add-emc_communication-details'))->with(['success' => 'Various communications uploaded Successfully']);
}
...
public function emc_communication_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-emc_communication-details'))->with(['success' => 'Various communications Updated Successfully']);
}

public function emc_communication_delete($id)
{
    $data = EmcVariousCommunication::where('id', $id)->delete();
    return redirect(url('add-emc_communication-details'))->with(['error' => 'Various communications deleted successfully']);
}
