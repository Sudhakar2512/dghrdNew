...
class HRM1Controller extends Controller
{
    ...
    public function Sparrow_save(Request $request)
    {
        ...
        return redirect(url('add-sparrow'))->with(['success' => 'Sparrow uploaded Successfully']);
    }
    ...
    public function Sparrow_delete($id)
    {
        ...
        return redirect(url('add-sparrow'))->with(['error' => 'Sparrow deleted successfully']);
    }
    ...
    public function apar_save(Request $request)
    {
        ...
        return redirect(url('add-apar'))->with(['success' => 'Apar uploaded Successfully']);
    }
    ...
    public function apar_delete($id)
    {
        ...
        return redirect(url('add-apar'))->with(['error' => 'Apar deleted successfully']);
    }
    ...
    public function ipr_save(Request $request)
    {
        ...
        return redirect(url('add-ipr'))->with(['success' => 'IPR uploaded Successfully']);
    }
    ...
    public function ipr_delete($id)
    {
        ...
        return redirect(url('add-ipr'))->with(['error' => 'IPR deleted successfully']);
    }
    ...
    public function group_a_save(Request $request)
    {
        ...
        return redirect(url('add-group-a'))->with(['success' => 'Group a data uploaded Successfully']);
    }
    ...
    public function group_a_delete($id)
    {
        ...
        return redirect(url('add-group-a'))->with(['error' => 'Group a data deleted successfully']);
    }
    ...
    public function group_b_save(Request $request)
    {
        ...
        return redirect(url('add-group-b'))->with(['success' => 'Group b data uploaded Successfully']);
    }
    ...
    {
        $data = RecruitmentRules::where('id', $id)->delete();
        return redirect(url('add-group-b'))->with(['error' => 'Group b data deleted successfully']);
    }
    ...
    public function group_c_save(Request $request)
    {
        ...
        return redirect(url('add-group-c'))->with(['success' => 'Group c data uploaded Successfully']);
    }
    ...
    {
        $data = RecruitmentRules::where('id', $id)->delete();
        return redirect(url('add-group-c'))->with(['error' => 'Group c data deleted successfully']);
    }
    ...
    public function canteen_save(Request $request)
    {
        ...
        return redirect(url('add-canteen-staff'))->with(['success' => 'Canteen Staff data uploaded Successfully']);
    }
    ...
    public function canteen_delete($id)
    {
        ...
        return redirect(url('add-canteen-staff'))->with(['error' => 'Canteen Staff data deleted successfully']);
    }
    ...
    public function cbn_save(Request $request)
    {
        ...
        return redirect(url('add-cbn'))->with(['success' => 'CBN data uploaded Successfully']);
    }
    ...
    public function cbn_delete($id)
    {
        ...
        return redirect(url('add-cbn'))->with(['error' => 'CBN data deleted successfully']);
    }
    ...
    public function crcl_save(Request $request)
    {
        ...
        return redirect(url('add-crcl'))->with(['success' => 'CRCL data uploaded Successfully']);
    }
    ...
    public function crcl_delete($id)
    {
        ...
        return redirect(url('add-crcl'))->with(['error' => 'CRCL data deleted successfully']);
    }
    ...
    public function dgpm_save(Request $request)
    {
        ...
        return redirect(url('add-dgpm'))->with(['success' => 'DGPM data uploaded Successfully']);
    }
    ...
    public function dgpm_delete($id)
    {
        ...
        return redirect(url('add-dgpm'))->with(['error' => 'DGPM data deleted successfully']);
    }
    ...
    public function Directorate_of_logistics_save(Request $request)
    {
        ...
        return redirect(url('add-directorate-of-logistics'))->with(['success' => 'Directorate Of Logistics data uploaded Successfully']);
    }
    ...
    public function Directorate_of_logistics_delete($id)
    {
        ...
        return redirect(url('add-directorate-of-logistics'))->with(['error' => 'Directorate Of Logistics data deleted successfully']);
    }
    ...
    public function dppr_save(Request $request)
    {
        ...
        return redirect(url('add-dppr'))->with(['success' => ' DPPR data uploaded Successfully']);
    }
    ...
    public function dppr_delete($id)
    {
        ...
        return redirect(url('add-dppr'))->with(['error' => 'DPPR data deleted successfully']);
    }
    ...
    public function dri_save(Request $request)
    {
        ...
        return redirect(url('add-dri'))->with(['success' => 'DRI data uploaded Successfully']);
    }
    ...
    public function dri_delete($id)
    {
        ...
        return redirect(url('add-dri'))->with(['error' => 'DRI data deleted successfully']);
    }
    ...
    public function rrs_of_directorates_save(Request $request)
    {
        ...
        return redirect(url('add-rrs-of-directorates'))->with(['success' => 'RRs of DIRECTORATES data uploaded Successfully']);
    }
    ...
    public function rrs_of_directorates_delete($id)
    {
        ...
        return redirect(url('add-rrs-of-directorates'))->with(['error' => 'RRs of DIRECTORATES data deleted successfully']);
    }
    ...
    public function systum_data_management_save(Request $request)
    {
        ...
        return redirect(url('add-systum-data-management'))->with(['success' => 'System and Data Managements data uploaded Successfully']);
    }
    ...
    public function systum_data_management_delete($id)
    {
        ...
        return redirect(url('add-systum-data-management'))->with(['error' => 'System and Data Managements data deleted successfully']);
    }
    ...
    public function telecommunication_wing_save(Request $request)
    {
        ...
        return redirect(url('add-telecommunication-wing'))->with(['success' => 'Telecommunication Wings data uploaded Successfully']);
    }
    ...
    public function telecommunication_wing_delete($id)
    {
        ...
        return redirect(url('add-telecommunication-wing'))->with(['error' => 'Telecommunication Wings data deleted successfully']);
    }
    ...
    public function seniority_list_save(Request $request)
    {
        ...
        return redirect(url('add-seniority-list'))->with(['success' => 'Seniority List uploaded Successfully']);
    }
    ...
    public function seniority_list_delete($id)
    {
        ...
        return redirect(url('add-seniority-list'))->with(['error' => 'Seniority List deleted successfully']);
    }
    ...
    public function dpc_save(Request $request)
    {
        ...
        return redirect(url('add-dpc1'))->with(['success' => 'DPCs data uploaded Successfully']);
    }
    ...
    public function dpc_delete($id)
    {
        ...
        return redirect(url('add-dpc1'))->with(['error' => 'DPCs data deleted successfully']);
    }
    ...
    public function empanelment_deputation_save(Request $request)
    {
        ...
        return redirect(url('add-empanelment-deputation'))->with(['success' => 'Empanelment Deputations data uploaded Successfully']);
    }
    ...
    public function empanelment_deputation_delete($id)
    {
        ...
        return redirect(url('add-empanelment-deputation'))->with(['error' => 'Empanelment Deputations data deleted successfully']);
    }
    ...
    public function cadre_restructuring_2018_save(Request $request)
    {
        ...
        return redirect(url('add-cadre-restructuring-2018'))->with(['success' => 'Cadre Restructurings data uploaded Successfully']);
    }
    ...
    public function cadre_restructuring_2018_delete($id)
    {
        ...
        return redirect(url('add-cadre-restructuring-2018'))->with(['error' => 'Cadre Restructurings data deleted successfully']);
    }
    ...
    public function sparrow_cbic_save(Request $request)
    {
        ...
        return redirect(url('add-sparrow-cbic'))->with(['success' => 'Sparrow Cbic data uploaded Successfully']);
    }
    ...
    public function sparrow_cbic_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-sparrow-cbic'))->with(['success' => 'Sparrow Cbic data Updated Successfully']);
    }

    public function sparrow_cbic_delete($id)
    {
        $data = SparrowCBIC::where('id', $id)->delete();
        return redirect(url('add-sparrow-cbic'))->with(['error' => 'Sparrow Cbic data deleted successfully']);
    }
    ...
    public function officer_details_save(Request $request)
    {
        ...
        return redirect(url('add-officer-details'))->with(['success' => 'Officer Detailes uploaded Successfully']);
    }
    ...
    public function officer_details_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-officer-details'))->with(['success' => 'Officer Detailes Updated Successfully']);
    }

    public function officer_details_delete($id)
    {
        $data = OfficerDetails::where('id', $id)->delete();
        return redirect(url('add-officer-details'))->with(['error' => 'Officer Detailes deleted successfully']);
    }
    ...
    public function various_communication_save(Request $request)
    {
        ...
        return redirect(url('add-various-communication'))->with(['success' => 'Various Communications data uploaded Successfully']);
    }
    ...
    public function various_communication_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-various-communication'))->with(['success' => 'Various Communications data Updated Successfully']);
    }

    public function various_communication_delete($id)
    {
        $data = VariousCommunicationFieldFormations::where('id', $id)->delete();
        return redirect(url('add-various-communication'))->with(['error' => 'Various Communications data deleted successfully']);
    }
  public function rajyabhasha_view($id = null)
    {
        $admin = request()->session()->get('admin-auth');
        $data = Rajyabhasha::orderBy('id', 'DESC')->get();
        $value = null;
        if ($id) {
            $value = Rajyabhasha::where('id', $id)->first();
        }
        return view('Dghrd.Admin.HRM1.rajyabhasha', ['admin' => $admin, 'data' => $data, 'value' => $value]);
    }

    public function rajyabhasha_save(Request $request)
    {
        #validation
        $this->validate($request, [
            "pdf" => "mimes:doc,pdf,docx,xlsx,xls,csv,txt,rtf,png,jpg,jpeg,odt,ods,pptx,ppt,gif",
        ...
        return redirect(url('add-rajyabhasha'))->with(['success' => 'Rajyabhasha uploaded Successfully']);
    }

    public function rajyabhasha_update(Request $request, $id)
    {
        #validation
        $this->validate($request, [
            "pdf" => "mimes:doc,pdf,docx,xlsx,xls,csv,txt,rtf,png,jpg,jpeg,odt,ods,pptx,ppt,gif",
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-rajyabhasha'))->with(['success' => 'Rajyabhasha Updated Successfully']);
    }

    public function rajyabhasha_delete($id)
    {
        $data = Rajyabhasha::where('id', $id)->delete();
        return redirect(url('add-rajyabhasha'))->with(['error' => 'Rajyabhasha deleted successfully']);
    }
    ...
    public function regularization_view($id = null)
    {
        $admin = request()->session()->get('admin-auth');
        $data = Regularization::orderBy('id', 'ASC')->get();
        $value = null;
        if ($id) {
            $value = Regularization::where('id', $id)->first();
        }
        return view('Dghrd.Admin.HRM1.Regularization', ['admin' => $admin, 'data' => $data, 'value' => $value]);
    }


    public function regularization_save(Request $request)
    {
        #validation
        $this->validate($request, [
            "pdf" => "mimes:doc,pdf,docx,xlsx,xls,csv,txt,rtf,png,jpg,jpeg,odt,ods,pptx,ppt,gif",
        ...
        return redirect(url('add-regularization'))->with(['success' => 'Regularization PDF uploaded Successfully']);
    }

    public function regularization_update(Request $request, $id)
    {
        #validation
        $this->validate($request, [
            "pdf" => "mimes:doc,pdf,docx,xlsx,xls,csv,txt,rtf,png,jpg,jpeg,odt,ods,pptx,ppt,gif",
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-regularization'))->with(['success' => 'Regularization updated Successfully']);
    }

    public function regularization_delete($id)
    {
        $data = Regularization::where('id', $id)->delete();
        return redirect(url('add-regularization'))->with(['error' => 'Regularization deleted successfully']);
    }
}
