...
class WelfareController extends Controller
{
    ...
    public function welfare_officer_save(Request $request)
    {
        ...
        return redirect(url('add-welfare_officer-details'))->with(['success' => 'Officer Detailes uploaded Successfully']);
    }
    ...
    public function welfare_officer_update(Request $request, $id)
    {
        ...
        $data->save();
        return redirect(url('add-welfare_officer-details'))->with(['success' => 'Officer Detailes Updated Successfully']);
    }

    public function welfare_officer_delete($id)
    {
        $data = WelfareOfficer::where('id', $id)->delete();
        return redirect(url('add-welfare_officer-details'))->with(['error' => 'Officer Detailes deleted successfully']);
    }
    ...
    public function compendium_save(Request $request)
    {
        ...
        return redirect(url('add-compendium-details'))->with(['success' => 'Compendium uploaded Successfully']);
    }
    ...
    public function compendium_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-compendium-details'))->with(['success' => 'Compendium Updated Successfully']);
    }

    public function compendium_delete($id)
    {
        $data = Compendium::where('id', $id)->delete();
        return redirect(url('add-compendium-details'))->with(['error' => 'Compendium deleted successfully']);
    }
    ...
    public function welfare_schemes_save(Request $request)
    {
        ...
        return redirect(url('add-welfare_sechemes-details'))->with(['success' => 'Welfare Secheme uploaded Successfully']);
    }
    ...
    public function welfare_schemes_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-welfare_sechemes-details'))->with(['success' => 'Welfare Secheme Updated Successfully']);
    }

    public function welfare_schemes_delete($id)
    {
        $data = WelfareScheme::where('id', $id)->delete();
        return redirect(url('add-welfare_sechemes-details'))->with(['error' => 'Welfare Secheme deleted successfully']);
    }
    ...
    public function action_plan_save(Request $request)
    {
        ...
        return redirect(url('add-action_plan-details'))->with(['success' => 'Action Plan uploaded Successfully']);
    }
    ...
    public function action_plan_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-action_plan-details'))->with(['success' => 'Action Plan Updated Successfully']);
    }

    public function action_plan_delete($id)
    {
        $data = ActionPlan::where('id', $id)->delete();
        return redirect(url('add-action_plan-details'))->with(['error' => 'Action Plan deleted successfully']);
    }
    ...
    public function schemes_save(Request $request)
    {
        ...
        return redirect(url('add-schemes-details'))->with(['success' => 'Scheme uploaded Successfully']);
    }
    ...
    public function schemes_update(Request $request, $id)
    {
        ...
        $data->date = $request->date;
        $data->save();
        return redirect(url('add-schemes-details'))->with(['success' => 'Scheme Updated Successfully']);
    }

    public function schemes_delete($id)
    {
        $data = Scheme::where('id', $id)->delete();
        return redirect(url('add-schemes-details'))->with(['error' => 'Scheme deleted successfully']);
    }
 ...
 public function welfare_ppt_save(Request $request)
 {
     ...
     return redirect(url('add-welfare_ppt-details'))->with(['success' => 'PPT uploaded Successfully']);
 }
 ...
 public function welfare_ppt_update(Request $request, $id)
 {
     ...
     $data->date = $request->date;
     $data->save();
     return redirect(url('add-welfare_ppt-details'))->with(['success' => 'PPT Updated Successfully']);
 }

 public function welfare_ppt_delete($id)
 {
     $data = WelfarePpt::where('id', $id)->delete();
     return redirect(url('add-welfare_ppt-details'))->with(['error' => 'PPT deleted successfully']);
 }
 ...
 public function welfare_manual_save(Request $request)
 {
     ...
     return redirect(url('add-welfare_manual-details'))->with(['success' => 'Manual uploaded Successfully']);
 }
 ...
 public function welfare_manual_update(Request $request, $id)
 {
     ...
     $data->date = $request->date;
     $data->save();
     return redirect(url('add-welfare_manual-details'))->with(['success' => 'Manual Updated Successfully']);
 }

 public function welfare_manual_delete($id)
 {
     $data = WelfareManual::where('id', $id)->delete();
     return redirect(url('add-welfare_manual-details'))->with(['error' => 'Manual deleted successfully']);
 }
# Comman Facilities
...
public function comman_facilties_save(Request $request)
{
    ...
    return redirect(url('add-comman_facilties-details'))->with(['success' => 'Comman Facilities uploaded Successfully']);
}
...
public function comman_facilties_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-comman_facilties-details'))->with(['success' => 'Comman Facilities Updated Successfully']);
}

public function comman_facilties_delete($id)
{
    $data = CommanFacility::where('id', $id)->delete();
    return redirect(url('add-comman_facilties-details'))->with(['error' => 'Comman Facilities deleted successfully']);
}
...
public function hotel_tieup_save(Request $request)
{
    ...
    return redirect(url('add-hotel_tieup-details'))->with(['success' => 'Hotel TieUps data uploaded Successfully']);
}
...
public function hotel_tieup_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-hotel_tieup-details'))->with(['success' => 'Hotel TieUps data Updated Successfully']);
}

public function hotel_tieup_delete($id)
{
    $data = HotelTieup::where('id', $id)->delete();
    return redirect(url('add-hotel_tieup-details'))->with(['error' => 'Hotel TieUps data deleted successfully']);
}
...
public function hotel_draft_save(Request $request)
{
    ...
    return redirect(url('add-hotel_draft-details'))->with(['success' => 'Draft List uploaded Successfully']);
}
...
public function hotel_draft_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-hotel_draft-details'))->with(['success' => 'Draft List Updated Successfully']);
}

public function hotel_draft_delete($id)
{
    $data = HotelDraft::where('id', $id)->delete();
    return redirect(url('add-hotel_draft-details'))->with(['error' => 'Draft List deleted successfully']);
}
...
public function guest_house_save(Request $request)
{
    ...
    return redirect(url('add-guest_house-details'))->with(['success' => 'Guest House data uploaded Successfully']);
}
...
public function guest_house_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-guest_house-details'))->with(['success' => 'Guest House data Updated Successfully']);
}

public function guest_house_delete($id)
{
    $data = GuestHouse::where('id', $id)->delete();
    return redirect(url('add-guest_house-details'))->with(['error' => 'Guest House data deleted successfully']);
}
...
public function covid_save(Request $request)
{
    ...
    return redirect(url('add-covid-details'))->with(['success' => 'Covid 19s data uploaded Successfully']);
}
...
public function covid_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-covid-details'))->with(['success' => 'Covid 19s data Updated Successfully']);
}

public function covid_delete($id)
{
    $data = Covid19::where('id', $id)->delete();
    return redirect(url('add-covid-details'))->with(['error' => 'Covid 19s data deleted successfully']);
}
...
public function proposels_save(Request $request)
{
    ...
    return redirect(url('add-praposels-details'))->with(['success' => 'Praposal uploaded Successfully']);
}
...
public function proposels_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-praposels-details'))->with(['success' => 'Praposal Updated Successfully']);
}

public function proposels_delete($id)
{
    $data = WelfareProposel::where('id', $id)->delete();
    return redirect(url('add-praposels-details'))->with(['error' => 'Praposal deleted successfully']);
}
...
public function welfare_communication_save(Request $request)
{
    ...
    return redirect(url('add-welfare_communication-details'))->with(['success' => 'Various Communications data uploaded Successfully']);
}
...
public function welfare_communication_update(Request $request, $id)
{
    ...
    $data->date = $request->date;
    $data->save();
    return redirect(url('add-welfare_communication-details'))->with(['success' => 'Various Communications data Updated Successfully']);
}

public function welfare_communication_delete($id)
{
    $data = WelfareVariousCommuniction::where('id', $id)->delete();
    return redirect(url('add-welfare_communication-details'))->with(['error' => 'Various Communications data deleted successfully']);
}
