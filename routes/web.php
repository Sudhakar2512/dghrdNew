...
Route::get('index2', [App\Http\Controllers\website\IndexController::class, 'index_page']);
...
Route::get('slider-delete/{id}', [App\Http\Controllers\Admin\CMSController::class, 'sliderdelete']);
 ...
 Route::get('suggestions', [App\Http\Controllers\Admin\CMSController::class, 'suggestion']);
 Route::get('delete_suggestion/{id}', [App\Http\Controllers\Admin\CMSController::class, 'suggestion_delete']);
#HRM1
...
#RajyaBhasha
Route::get('add-rajyabhasha/{id?}', [App\Http\Controllers\Admin\HRM1Controller::class, 'rajyabhasha_view']);
Route::post('add-rajyabhasha', [App\Http\Controllers\Admin\HRM1Controller::class, 'rajyabhasha_save']);
Route::post('add-rajyabhasha/{id?}', [App\Http\Controllers\Admin\HRM1Controller::class, 'rajyabhasha_update']);
Route::get('rajyabhasha-delete/{id}', [App\Http\Controllers\Admin\HRM1Controller::class, 'rajyabhasha_delete']);
...
Route::get('photoalbum/{id?}', [App\Http\Controllers\Admin\GalleryController::class, 'album_view']);
Route::post('photoalbum', [App\Http\Controllers\Admin\GalleryController::class, 'album_save']);
Route::post('photoalbum/{id?}', [App\Http\Controllers\Admin\GalleryController::class, 'album_update']);
Route::get('photoalbumdelete/{id}', [App\Http\Controllers\Admin\GalleryController::class, 'album_delete']);

#hr_conference
Route::get('add-hr_conference/{id?}', [App\Http\Controllers\Admin\HRConController::class, 'hr_con'])->name('hr_con');
Route::post('add-hr_conference', [App\Http\Controllers\Admin\HRConController::class, 'hr_conference_save']);
Route::post('add-hr_conference/{id?}', [App\Http\Controllers\Admin\HRConController::class, 'hr_conference_update']);
Route::get('hr_conference-delete/{id}', [App\Http\Controllers\Admin\HRConController::class, 'hr_conference_delete']);
});
...
Route::get('/hrm1', [App\Http\Controllers\website\IndexController::class, 'hrm1']);
Route::get('/hrm2', [App\Http\Controllers\website\IndexController::class, 'hrm2']);
Route::get('/infra_emc', [App\Http\Controllers\website\IndexController::class, 'infra_emc']);
...
Route::post('/suggestion', [App\Http\Controllers\website\IndexController::class, 'store'])->name('suggestions.store');
Route::get('/rti', [App\Http\Controllers\website\IndexController::class, 'rti']);
Route::get('/training', [App\Http\Controllers\website\IndexController::class, 'training']);
Route::get('/gallery_album', [App\Http\Controllers\website\IndexController::class, 'gallery_album']);
Route::get('/album/view/{id}', [App\Http\Controllers\website\IndexController::class, 'gallery_album_view']);
Route::get('/faq', [App\Http\Controllers\website\IndexController::class, 'faq']);
Route::get('/HR-con', [App\Http\Controllers\website\IndexController::class, 'HR_con']);
Route::get('/regularization', [App\Http\Controllers\website\IndexController::class, 'regularization']);
Route::get('/pdf-view', [App\Http\Controllers\website\IndexController::class, 'viewPdf']);
Route::get('/flipbook-view', [App\Http\Controllers\website\IndexController::class, 'viewFlipbook']);
Route::get('/manas-ebook', [App\Http\Controllers\website\IndexController::class, 'viewManas'])->name('manas');
Route::get('/flipbook/{id}', [App\Http\Controllers\website\IndexController::class, 'Flipbook'])->name('ebook.show');
...
Route::get('/ipr', [App\Http\Controllers\website\Hrm1Controller::class, 'ipr']);
...
Route::get('/rajyabhasha', [App\Http\Controllers\website\Hrm1Controller::class, 'bhasha']);
...
Route::get('add-regularization/{id?}', [App\Http\Controllers\Admin\HRM1Controller::class, 'regularization_view']);
Route::post('submit-regularization', [App\Http\Controllers\Admin\HRM1Controller::class, 'regularization_save']);
Route::post('update-regularization/{id?}', [App\Http\Controllers\Admin\HRM1Controller::class, 'regularization_update']);
Route::get('regularization-delete/{id}', [App\Http\Controllers\Admin\HRM1Controller::class, 'regularization_delete']);
