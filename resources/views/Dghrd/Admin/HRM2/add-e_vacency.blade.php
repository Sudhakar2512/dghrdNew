...
<x-layout>
    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <h3 class="page-title">e-Vacancy Module Updates
            </h3>
            <!-- row -->
...
@if ($value)
    <form method="post" action="{{ url('add-e_vacency') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
@else
    <form method="post" action="{{ url('add-e_vacency') }}" enctype="multipart/form-data">
@endif
@csrf
<div class="mb-3">
            ...
            <div class="col-12">
                <div class="thm-card">
                    <div class="thm-card-head">
                        <h4 class="thm-card-title"><i class="thm-card-title-icon ti-file"></i> e-Vacancy Module Updates Table</h4>
                    </div>
                    <!-- /.box-header -->
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->date ?? '' }}</td>
                                            <td>
                                                <a href="{{ url('e_vacency-delete') . '/' . $data->id ?? '' }}"><button
                                                        type="button" class="btn btn-danger">
                                                        <i class="ti-trash" style="font-size: 18px;"></i>
                                                    </button></a>
                                                <a href="{{ url('add-e_vacency') . '/' . $data->id ?? '' }}"><button
