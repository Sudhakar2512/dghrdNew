...
<x-layout>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <h3 class="page-title">Swachhta Action Plan
            </h3>
            <!-- row -->
...
@if ($value)
    <form method="post" action="{{ url('add-swachhta') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
@else
    <form method="post" action="{{ url('add-swachhta') }}" enctype="multipart/form-data">
@endif
@csrf
<div class="mb-3">
    <div class="form-group">
      ...
      <select class="form-select" name="tab" required>
        ...
        <option value="1" @if($value && $value->tab == "1") selected @endif>Letter</option>
        <option value="2" @if($value && $value->tab == "2") selected @endif>Awards</option>
        <option value="3" @if($value && $value->tab == '3') selected @endif>Booklets</option>
        <option value="4" @if($value && $value->tab == '3') selected @endif>Expenditure</option>
            ...
            <div class="col-12">
                <div class="thm-card">
                    <div class="thm-card-head">
                        <h4 class="thm-card-title"><i class="thm-card-title-icon ti-file"></i>Swachhta Action Plan
                            Table</h4>
                    </div>
                    <!-- /.box-header -->
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->date ?? '' }}</td>
                                            <td>
                                                <a href="{{ url('swachhta-delete') . '/' . $data->id ?? '' }}"><button
                                                        type="button" class="btn btn-danger">
                                                        <i class="ti-trash" style="font-size: 18px;"></i>
                                                    </button></a>
                                                <a href="{{ url('add-swachhta') . '/' . $data->id ?? '' }}"><button
