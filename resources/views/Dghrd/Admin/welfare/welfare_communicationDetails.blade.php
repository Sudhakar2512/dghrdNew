...
@if ($value)
    <form method="post" action="{{ url('add-welfare_communication-details') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
@else
    <form method="post" action="{{ url('add-welfare_communication-details') }}" enctype="multipart/form-data">
@endif
@csrf
<div class="mb-3">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->date ?? '' }}</td>
                                            <td>
                                                <a href="{{ url('welfare_communication-details-delete') . '/' . $data->id ?? '' }}"><button
                                                        type="button" class="btn btn-danger">
                                                        <i class="ti-trash" style="font-size: 18px;"></i>
                                                    </button></a>
                                                <a href="{{ url('add-welfare_communication-details') . '/' . $data->id ?? '' }}"><button
