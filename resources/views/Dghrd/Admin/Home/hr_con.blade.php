<x-layout>
    <div class="content-body">
        ...
        <h3 class="page-title">HR Confrences</h3>
        <!-- row -->
            ...
            <div class="card-body thm-card-body">
                <div class="row">
                    <div class="col-md-8"> <!-- Increased width to col-md-8 -->
                        @if ($value)
                            <form method="post" action="{{ url('add-hr_conference') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
                        @else
                            <form method="post" action="{{ url('add-hr_conference') }}" enctype="multipart/form-data">
                        @endif
                        @csrf
                        <div class="mb-3">
        ...
        <div class="col-12"
            <div class="thm-card">
                <div class="thm-card-head">
                    <h4 class="thm-card-title"><i class="thm-card-title-icon ti-help-alt"></i> Apar(Missing APARs) Table</h4>
                </div>
                <!-- /.box-header -->
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $key => $data)
                                    <tr>
                                        ...
                                        <td>{{ $data->date ?? '' }}</td>
                                        <td>
                                            <a href="{{ url('hr_conference-delete') . '/' . $data->id ?? '' }}"><button type="button" class="btn btn-danger"><i class="ti-trash" style="font-size: 18px;"></i></button></a>
                                            <a href="{{ url('add-hr_conference') . '/' . $data->id ?? '' }}"><button type="button" class="btn btn-primary " > <i class="ti-pencil" style="font-size: 18px;"></i></button></a>
                                        </td>
                                    </tr>
