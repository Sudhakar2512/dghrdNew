<x-layout>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4 thm-card">
                ...
                <div class="card-body thm-card-body">
                    <div class="row">
                        <div class="col-md-8">
                            @if ($value)
                                <form method="post" action="{{ url('slider') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
                            @else
            ...
            <div class="col-12 card thm-card">
               
                    <div class="thm-card-head">
                        <h4 class="thm-card-title"><i class="thm-card-title-icon ti-image"></i>Slider Images Table</h4>
                    </div>
                    <!-- /.box-header -->
