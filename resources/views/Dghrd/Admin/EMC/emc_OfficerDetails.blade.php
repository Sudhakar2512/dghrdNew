...
@if ($value)
    <form method="post" action="{{ url('add-emc_officer-details') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
@else
    <form method="post" action="{{ url('add-emc_officer-details') }}" enctype="multipart/form-data">
@endif
@csrf
<div class="mb-3">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->date ?? '' }}</td>
                                            <td>
                                                <a href="{{ url('emc_officer-details-delete') . '/' . $data->id ?? '' }}"><button
                                                        type="button" class="btn btn-danger">
                                                        <i class="ti-trash" style="font-size: 18px;"></i>
                                                    </button></a>
                                                <a href="{{ url('add-emc_officer-details') . '/' . $data->id ?? '' }}"><button
