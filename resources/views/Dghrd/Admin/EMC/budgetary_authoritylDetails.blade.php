...
<x-layout>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <h3 class="page-title">Budgetary Authority Details
...
@if ($value)
    <form method="post" action="{{ url('add-budgetary_authority-details') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
@else
    <form method="post" action="{{ url('add-budgetary_authority-details') }}" enctype="multipart/form-data">
@endif
@csrf
<div class="mb-3">
            ...
            <div class="col-12">
                <div class="thm-card">
                    <div class="thm-card-head">
                        <h4 class="thm-card-title"><i class="thm-card-title-icon ti-file"> </i> Budgetary Authority Details
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>{{ $data->date ?? '' }}</td>
                                            <td>
                                                <a href="{{ url('budgetary_authority-details-delete') . '/' . $data->id ?? '' }}"><button
                                                        type="button" class="btn btn-danger">
                                                        <i class="ti-trash" style="font-size: 18px;"></i>
                                                    </button></a>
                                                <a href="{{ url('add-budgetary_authority-details') . '/' . $data->id ?? '' }}"><button
