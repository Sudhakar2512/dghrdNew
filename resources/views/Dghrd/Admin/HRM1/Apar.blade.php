<x-layout>
            ...
            <div class="content-body">
                ...
                <div class="container-fluid">
                    ...
                    <h3 class="page-title">Apar(Missing APARs)</h3>
                    <!-- row -->
...
<div class="row">
    <div class="col-md-8"> <!-- Increased width to col-md-8 -->
        @if ($value)
            <form method="post" action="{{ url('add-apar') . '/' . $value->id ?? '' }}" enctype="multipart/form-data">
        @else
            <form method="post" action="{{ url('add-apar') }}" enctype="multipart/form-data">
        @endif
        @csrf
        <div class="mb-3">
 ...
 {{-- Table --}}
                    ...
                    <div class="col-12">
                        <div class="thm-card">
                            <div class="thm-card-head">
                                <h4 class="thm-card-title"> <i class="thm-card-title-icon ti-file"></i> Apar(Missing APARs) Table</h4>
                            </div>
                            <!-- /.box-header -->
  ...
  <td>
                                                ...
                                                @endphp
                                                                                              ...
                                                                                              <td>{{ $data->date ?? '' }}</td>
                                                    <td>
                                                        <a href="{{ url('apar-delete') . '/' . $data->id ?? '' }}"><button
                                                                type="button" class="btn btn-danger">
                                                                <i class="ti-trash" style="font-size: 18px;"></i>
                                                            </button></a>
                                                        <a href="{{ url('add-apar') . '/' . $data->id ?? '' }}"><button
