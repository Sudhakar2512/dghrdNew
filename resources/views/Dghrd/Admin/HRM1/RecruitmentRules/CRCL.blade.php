...
<div class="col-md-8"> <!-- Increased width to col-md-8 -->
    @if ($value)
    <form method="post" action="{{ url('add-crcl') . '/' . $value->id ?? '' }}"
        enctype="multipart/form-data">
        @else
<form method="post" action="{{url('add-crcl')}}" enctype="multipart/form-data">
    @endif
    @csrf
    <div class="mb-3">
        <div class="form-group">
          ...
          <select class="form-select" name="sub_tab" required>
            ...
            <option value="1" @if($value && $value->sub_tab == '1' ) selected @endif>CHEMICAL ASSISTANT</option>
            <option value="2" @if($value && $value->sub_tab == '2') selected @endif>CRCL GR-A & B</option>
            <option value="3" @if($value && $value->sub_tab == '3') selected @endif>CRCL GR-C</option>
            ...
            <div class="col-12">
                <div class="thm-card">
                    <div class="thm-card-head">
                        <h4 class="thm-card-title"> <i class="thm-card-title-icon ti-file"></i> CRCL Table</h4>
                    </div>
                    <!-- /.box-header -->
