<x-layout>
    ...
    <div class="content-body">
        ...
        <div class="container-fluid">
            ...
            <h3 class="page-title">Canteen Staff
...
<div class="col-md-8"> <!-- Increased width to col-md-8 -->
    @if ($value)
                                                <form method="post" action="{{ url('add-canteen-staff') . '/' . $value->id ?? '' }}"
                                                    enctype="multipart/form-data">
                                                    @else
                                            <form method="post" action="{{url('add-canteen-staff')}}" enctype="multipart/form-data">
                                                @endif
                                                @csrf
                                                <div class="mb-3">
                                                    <div class="form-group">
                                                      ...
                                                      <select class="form-select" name="sub_tab" required>
                                                        ...
                                                        <option value="2" @if($value && $value->sub_tab ?? '' == '2') selected @endif>MANAGER GRADE-II & MANAGER CUM ACCOUNTANT</option>
                                                      </select>
                                                    </div>
                                                    @error('sub_tab')
            ...
            <div class="col-12">
                <div class="thm-card">
                    <div class="thm-card-head">
                        <h4 class="thm-card-title"> <i class="thm-card-title-icon ti-file"></i>Canteen Staff Table</h4>
                    </div>
                    <!-- /.box-header -->
                                    ...
                                    @foreach ($data as $key => $data)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                MANAGER GRADE-II & MANAGER CUM ACCOUNTANT
                                                @endif
                                            </td>
                                            ...
                                            <td>{{ $data->date ?? '' }}</td>
                                            <td>
                                                <a href="{{ url('canteen-staff-delete') . '/' . $data->id ?? '' }}"><button
                                                        type="button" class="btn btn-danger">
                                                        <i class="ti-trash" style="font-size: 18px;"></i>
                                                    </button></a>
                                                <a href="{{ url('add-canteen-staff') . '/' . $data->id ?? '' }}"><button
